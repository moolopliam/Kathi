...
namespace concert.Controllers
{
    public class ProvincesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDProvince,NameProvince")] Province province)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDProvince,NameProvince")] Province province)
        {
            if (ModelState.IsValid)
            {
